...
<div class="row">
	...
	<div class="well well-small">
		<h1>Giỏ hàng <small class="pull-right"> Số sản phẩm: ${ TotalQuantyCart } </small></h1>
	<hr class="soften"/>	
              ...
              <tbody>
				...
				<c:forEach var="item" items="${ Cart }">
					<tr>
	                  ...
	                  <td>
						<input type="number" min="0" max="99" class="span1" style="max-width:34px" placeholder="1" id="quanty-cart-${ item.key }" size="16" type="text" value="${ item.value.quanty }">
					  </td>
	                  <td>
	...
	<a href="san-pham/1" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Tiếp tục mua sắm </a>
