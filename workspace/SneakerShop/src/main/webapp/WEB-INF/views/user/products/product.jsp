	...
	<div class="row product-content">
		<div id="sidebar" class="span3">
			<div class="well well-small">
				<ul class="nav nav-list">
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Converse</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Adidas</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Nike</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Bitis Hunter</a></li>
			...
			<div class="well well-small alert alert-warning cntr">
				<h2>Giảm giá 50%</h2>
				<p>
					Mừng cá tháng 4. <br> <br> <a class="defaultBtn" href="#">Tại đây </a>
				</p>
			</div>
			<div class="well well-small">
				...
				<li>
					<div class="thumbnail">
						...
						<div class="caption" style="text-align: center;">
							<h4>
								<a class="defaultBtn" href="product_details.html">Xem thêm</a>
							</h4>
						</div>
